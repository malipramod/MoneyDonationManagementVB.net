...
Public Class CRDonorName
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DonationManagement.CRDonorName.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRDonorName
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRDonorName = New CRDonorName
        rpt.Site = Me.Site
        Return rpt
    End Function
