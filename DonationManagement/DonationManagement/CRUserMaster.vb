...
Public Class CRUserMaster
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DonationManagement.CRUserMaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRUserMaster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRUserMaster = New CRUserMaster
        rpt.Site = Me.Site
        Return rpt
    End Function
