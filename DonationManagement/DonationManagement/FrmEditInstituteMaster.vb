...
Public Class FrmEditInstituteMaster
    ...
    Private Sub btnUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        If cmbInstituteName.SelectedIndex > -1 Then
            str = ""
            str = "Update InstituteMaster set InstName='" + txtInstituteName.Text + "',Area='" + txtArea.Text + "',Address='" + txtAddress.Text + "',Description='" + txtDescription.Text + "' where InstID = " + cmbInstituteName.SelectedIndex.ToString()
            cmd = New SqlCommand(str, con)
            cmd.ExecuteNonQuery()
            MessageBox.Show("Updated Successfully", "Institute Master")
    ...
    Private Sub cmbInstituteName_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbInstituteName.SelectedIndexChanged
        If (cmbInstituteName.SelectedIndex > -1) Then
            str = ""
            str = "Select * from InstituteMaster where InstID=" + cmbInstituteName.SelectedIndex.ToString()
            da = New SqlDataAdapter(str, con)
            ds = New DataSet()
            da.Fill(ds)
            If (ds.Tables(0).Rows.Count > 0) Then
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        If cmbInstituteName.SelectedIndex > -1 Then
            str = ""
            str = "Delete From InstituteMaster Where InstID=" + cmbInstituteName.SelectedIndex.ToString()
            cmd = New SqlCommand(str, con)
            cmd.ExecuteNonQuery()
            ...
            txtAddress.Text = ""
            txtDescription.Text = ""
            MessageBox.Show("Delete Record Sucessfuly", "Institute Master")
