...
Public Class CRSpecialMebership
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DonationManagement.CRSpecialMebership.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRSpecialMebership
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRSpecialMebership = New CRSpecialMebership
        rpt.Site = Me.Site
        Return rpt
    End Function
